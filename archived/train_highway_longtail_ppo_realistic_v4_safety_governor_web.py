...
This V4 safety-governor version keeps the active overtaking behaviour from V2/V3,
...
Recommended commands:
    ...
    python train_highway_longtail_ppo_realistic_v4_safety_governor_web.py --timesteps 300000

    # Evaluate and record videos
    python train_highway_longtail_ppo_realistic_v4_safety_governor_web.py --skip-train --video-dir videos --debug-eval

    # Make traffic harder/more complex
    python train_highway_longtail_ppo_realistic_v4_safety_governor_web.py --traffic-mode dense --timesteps 400000

    # Experimental continuous steering/throttle; this needs a fresh model
    python train_highway_longtail_ppo_realistic_v4_safety_governor_web.py --continuous-action --timesteps 500000
"""
...
class RealisticHighwayWrapper(gym.Wrapper):
    ...
    def _apply_speed_governor_before_step(self, action: Any) -> Any:
        ...
        This is the important V4 fix. In DiscreteMetaAction, IDLE does not mean
...
def model_stem(args: argparse.Namespace) -> str:
    ...
    return f"ppo_highway_longtail_realistic_v4_safety_governor_{suffix}_{args.traffic_mode}"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--log-dir", type=str, default="runs/ppo_highway_longtail_realistic_v4_safety_governor")
